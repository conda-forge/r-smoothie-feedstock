...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-smoothie-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-smoothie-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-smoothie-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-smoothie-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-smoothie-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-smoothie-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-smoothie` can be installed with:

```
conda install r-smoothie
```

It is possible to list all of the versions of `r-smoothie` available on your platform with:
